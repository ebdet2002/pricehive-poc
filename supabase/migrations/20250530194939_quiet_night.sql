/*
  ...
  1. Organizations and Users
    - Manufacturers: Acme Beverages, Fresh Foods
    - Retailers: SuperMart, Corner Store, Premium Grocers
    - Sample users for each role
    
  2. Products and Categories
    - Beverage products from Acme
    - Food products from Fresh Foods
    - Various product categories
    
  3. Product Assignments and Pricing
    - Products assigned to retailers
    - Sample price changes and discounts
    - Audit trail entries
*/
...
-- Sample Discounts
INSERT INTO discounts (id, product_assignment_id, type, category, value, start_date, end_date, status, created_at, reviewed_at, proposed_by, reviewed_by, rejection_reason) VALUES
  ('8c9d0e1f-2a3b-4c5d-6e7f-8a9b0c1d2e3f', 'c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f', 'percentage', 'temporary_price_reduction', 15.00, '2024-03-01 00:00:00+00', '2024-04-30 00:00:00+00', 'approved', '2024-03-01 09:00:00+00', '2024-03-02 10:30:00+00', '1b01a71e-523e-45b8-a6dd-29e850fc9d11', 'e3da2a87-8b6c-4064-9d72-fbc3eb3afc0d', NULL),
  ('9d0e1f2a-3b4c-5d6e-7f8a-9b0c1d2e3f4a', '0a1b2c3d-4e5f-6a7b-8c9d-0e1f2a3b4c5d', 'fixed_amount', 'feature_sale', 0.50, '2024-03-10 00:00:00+00', '2024-05-15 00:00:00+00', 'pending', '2024-03-10 11:15:00+00', NULL, '1b01a71e-523e-45b8-a6dd-29e850fc9d11', NULL, NULL),
  ('0e1f2a3b-4c5d-6e7f-8a9b-0c1d2e3f4a5b', 'e5f6a7b8-c9d0-e1f2-a3b4-c5d6e7f8a9b0', 'percentage', 'seasonal_sale', 20.00, '2024-03-05 00:00:00+00', '2024-06-30 00:00:00+00', 'rejected', '2024-03-05 14:20:00+00', '2024-03-07 08:45:00+00', '1b01a71e-523e-45b8-a6dd-29e850fc9d11', 'e3da2a87-8b6c-4064-9d72-fbc3eb3afc0d', 'Discount percentage too high');
