...
/*
  ...
  1. Data Setup
    ...
    - Adds sample organizations (manufacturers and retailers)
    - Creates product categories
    - Sets up user profiles
    - Adds sample products
    - Creates product assignments
    - Adds sample price changes and discounts
    - Creates audit log entries

  2. Security
    - All tables have RLS enabled
    - Data follows existing RLS policies
*/
...
INSERT INTO price_changes (id, product_assignment_id, current_price, new_price, start_date, status, created_at, reviewed_at, rejection_reason, proposed_by) VALUES
  ('4e5f6a7b-8c9d-0e1f-2a3b-4c5d6e7f8a9b', 'a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d', 2.50, 2.75, '2024-03-01 00:00:00+00', 'pending', '2024-02-25 10:00:00+00', NULL, NULL, '1b01a71e-523e-45b8-a6dd-29e850fc9d11'),
  ('5f6a7b8c-9d0e-1f2a-3b4c-5d6e7f8a9b0c', 'b2c3d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e', 2.25, 2.40, '2024-03-01 00:00:00+00', 'approved', '2024-02-20 14:30:00+00', '2024-02-22 09:15:00+00', NULL, '1b01a71e-523e-45b8-a6dd-29e850fc9d11'),
  ('6a7b8c9d-0e1f-2a3b-4c5d-6e7f8a9b0c1d', 'f6a7b8c9-d0e1-f2a3-b4c5-d6e7f8a9b0c1', 2.75, 3.00, '2024-03-15 00:00:00+00', 'rejected', '2024-02-28 11:45:00+00', '2024-03-01 16:20:00+00', 'Price increase too high', '1b01a71e-523e-45b8-a6dd-29e850fc9d11'),
  ('7b8c9d0e-1f2a-3b4c-5d6e-7f8a9b0c1d2e', 'd4e5f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a', 3.99, 4.19, '2024-04-01 00:00:00+00', 'pending', '2024-03-15 13:00:00+00', NULL, NULL, '1b01a71e-523e-45b8-a6dd-29e850fc9d11');

-- Sample Discounts
INSERT INTO discounts (id, product_assignment_id, type, category, value, start_date, end_date, status, created_at, reviewed_at, proposed_by) VALUES
  ('8c9d0e1f-2a3b-4c5d-6e7f-8a9b0c1d2e3f', 'c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f', 'percentage', 'temporary_price_reduction', 15.00, '2024-03-01 00:00:00+00', '2024-04-30 00:00:00+00', 'approved', '2024-03-01 09:00:00+00', '2024-03-02 10:30:00+00', '1b01a71e-523e-45b8-a6dd-29e850fc9d11'),
  ('9d0e1f2a-3b4c-5d6e-7f8a-9b0c1d2e3f4a', '0a1b2c3d-4e5f-6a7b-8c9d-0e1f2a3b4c5d', 'fixed_amount', 'feature_sale', 0.50, '2024-03-10 00:00:00+00', '2024-05-15 00:00:00+00', 'pending', '2024-03-10 11:15:00+00', NULL, '1b01a71e-523e-45b8-a6dd-29e850fc9d11'),
  ('0e1f2a3b-4c5d-6e7f-8a9b-0c1d2e3f4a5b', 'e5f6a7b8-c9d0-e1f2-a3b4-c5d6e7f8a9b0', 'percentage', 'seasonal_sale', 20.00, '2024-03-05 00:00:00+00', '2024-06-30 00:00:00+00', 'rejected', '2024-03-05 14:20:00+00', '2024-03-07 08:45:00+00', '1b01a71e-523e-45b8-a6dd-29e850fc9d11');
